...
">
        ...
        <div class="navbar-collapse-header d-md-none">
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="../index.html">
                <img src="../assets/img/brand/blink.png">
              </a>
            </div>
  ...
  <div class="main-content">
    ...
    <!-- End Navbar -->
    <!-- Header -->
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 100px; background-image:url(./assets/img/brand/gif.gif); background-size: cover; background-position: center top;">
      <!-- Mask -->
...
<div class="container-login100">
  <div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
	<center><form action="newPass.php" name="UpdateForm" method="POST">
	<?php
    ...
    <div class="col-lg-6">
      <div class="form-group">
		...
		<br><center> Change New Password :   <input type="text" class="form-control form-control-alternative" name="password" value="<?php echo $row['password']; ?>" ></center>
  </div>
</div>
	...
	<center><input type="submit" class="btn btn-info" value="Update new details"></center><br>
