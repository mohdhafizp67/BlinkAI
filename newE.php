        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
                ...
                <form>
                  <h6 class="heading-small text-muted mb-4">Update Email:</h6>
                  <div class="pl-lg-4">
                    <div class="row">

                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-username"><a href='newP.php'>Email</a></label>
                          <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Username" value="<?php echo $_SESSION['email'];?>">
                        </div>
                      </div>
...
?>
<!-- form update -->
	<form action="newEmail.php" name="UpdateForm" method="POST" onsubmit="return confirm ('Are you sure to update your email?') ">
	<?php
...
<center>
    <div class="col-lg-6">
      <div class="form-group">
		...
		Change New Email: <input type="email" class="form-control form-control-alternative" name="email" value="<?php echo $row['email']; ?>" >
  </div>
  </div>
