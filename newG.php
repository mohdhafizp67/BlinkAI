        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
                ...
                <form>
                  <h6 class="heading-small text-muted mb-4">Update Gender:</h6>
                  <div class="pl-lg-4">
                    <div class="row">

                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-username"><a href='newP.php'>Gender</a></label>
                          <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Username" value="<?php echo $_SESSION['gender'];?>">
                        </div>
                      </div>
...
?>
<!-- form update -->
	<form action="newGen.php" name="UpdateForm" method="POST">
	<?php
	while($row = mysqli_fetch_array($resultGet,MYSQLI_BOTH)){  ?>

     <center>
    <br><br>Gender: <?php $ivalue = $row['gender'];?>
    <input type="radio" name="gender" value="male" <?php if ($ivalue == "male") echo "checked";?>>
    <label for="male">Male</label>
    <input type="radio" name="gender" value="female" <?php if ($ivalue == "female") echo "checked";?>>
